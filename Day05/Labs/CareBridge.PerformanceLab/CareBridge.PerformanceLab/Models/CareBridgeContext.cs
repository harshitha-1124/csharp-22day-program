...
public partial class CareBridgeContext : DbContext
{
    ...
    public virtual DbSet<ClaimsView> ClaimsViews { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ClaimId).HasName("PK__Claim__EF2E139B2CD48CDF");
        ...
        modelBuilder.Entity<ClaimsView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Claims_view");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BEDCDAA3440");
        ...
        {
            entity.HasKey(e => e.DiagnosisId).HasName("PK__Diagnosi__0C54CC7330BC1836");
        ...
        {
            entity.HasKey(e => e.EncounterId).HasName("PK__Encounte__4278DD368E455034");
        ...
        {
            entity.HasKey(e => e.InsuranceId).HasName("PK__Insuranc__74231A246E2AC3F2");
        ...
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patient__970EC3661FB0F095");
            ...
            entity.HasIndex(e => e.Mrn, "UQ__Patient__C790FDB4E44A3C33").IsUnique();
        ...
        {
            entity.HasKey(e => e.ProcedureId).HasName("PK__Procedur__54C2E52D66750E87");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687DF58445FD");
